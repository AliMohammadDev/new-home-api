...
class CategorySeeder extends Seeder
{
  ...
  public function run(): void
  {
    $categories = [
      [
        'name' => ['en' => 'Cookware', 'ar' => 'أدوات الطبخ'],
        'description' => [
      ...
      [
        'name' => ['en' => 'Tableware', 'ar' => 'أدوات المائدة'],
        'description' => [
      ...
      [
        'name' => ['en' => 'Bakeware', 'ar' => 'أدوات الخبز'],
        'description' => [
      ...
      [
        'name' => ['en' => 'Drinkware', 'ar' => 'أدوات الشرب'],
        'description' => [
